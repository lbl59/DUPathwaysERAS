...
N_REALIZATIONS=1000
SOLS_FILE_NAME="ComSol_140_RECONSTRUCTED_DVs.csv"
RDM_PER_JOB=2
N_NODES=50
N_TASKS=200
RDM=1600
...
time ibrun python3 defection_reeval.py 24 $N_REALIZATIONS $DATA_DIR $RDM $SOLS_FILE_NAME $N_TASKS $RDM_PER_JOB"
echo -e $SLURM | sbatch
sleep 0.5
#donemod
