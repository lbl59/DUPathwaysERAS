...
for i in range(N_RDM_PER_JOB):
    command_gen_tables1 = "./triangleSimulation -T {} -t 2344 -r {} -d {} -C 1 -D pwl -E pwl -F 1 -O /rof_tables/RDM_{}/ -e 0 -U TestFiles/rdm_factors/WJLWTP_rdm_utilities_paper3_reeval.csv -W TestFiles/rdm_factors/WJLWTP_rdm_watersources_paper3_reeval.csv -P TestFiles/rdm_factors/WJLWTP_rdm_policies_paper3_reeval.csv -R {} -s {} -m 0 -p false".format(OMP_NUM_THREADS, N_REALIZATIONS, DATA_DIR, RDM + rank + N_NODES * i, RDM + rank + N_NODES * i, SOLS_FILE_NAME)
