...
%rdm_all = load('RDM_LHS_inflows.csv'); % new file of sinusoidal factors
...
%rdm = repmat(rdm_all(sample_no + 1, :), num_realizations, 1); % not using these so not important?
