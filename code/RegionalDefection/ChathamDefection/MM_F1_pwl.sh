DATA_DIR=/ocean/projects/ees200007p/dfg42/paper3/ChathamDefection/
N_REALIZATIONS=1000
...
SLURM="#!/bin/bash\n\
#SBATCH -n 200 -N 50\n\
#SBATCH --job-name=chatham_prod\n\
#SBATCH --output=output/chatham_prod.out\n\
#SBATCH --error=output/chatham_prod.err\n\
#SBATCH -p RM\n\
#SBATCH -t 4:30:00\n\
