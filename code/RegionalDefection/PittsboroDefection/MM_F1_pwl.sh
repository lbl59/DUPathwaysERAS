DATA_DIR=/ocean/projects/ees200007p/dfg42/paper3/PittsboroDefection/
N_REALIZATIONS=1000
...
SLURM="#!/bin/bash\n\
#SBATCH -n 200 -N 50\n\
#SBATCH --job-name=pittsboro_prod\n\
#SBATCH --output=output/pittsboro_prod.out\n\
#SBATCH --error=output/pittsboro_prod.err\n\
#SBATCH -p RM\n\
#SBATCH -t 2:00:00\n\
